...
python loft_run_evaluation.py \
  --answer_file_path ./rag_datasets/nq/128k/test_queries.jsonl \
  --pred_file_path ./outputs/nq/128k_summary/rag_gpt_4o_mini_rag_custom_phi_orpo_hard_short_012/batch_query_rag_mqn_custom3_b8_1e6_beta2.5_summary_preds.jsonl \
  --task_type rag

python loft_run_evaluation.py \
  --answer_file_path ./rag_datasets/nq_train/all_128k_summary/train_chunk_01_queries.jsonl \
  --pred_file_path ./outputs/nq_train/all_128k_summary/rag_gpt_4o_mini_mistral/batch_query_rag_gold_chunk_01_summary_preds.jsonl \
  --task_type rag
