...
def main(args):
    ...
    get_summary_full_prompt(dataset=f"{dataset}", 
                            original_input_dir=f"{dataset}/128k", 
                            original_input_summary_dir=f"{dataset}/128k_summary/{input_summary_dir}",
                            original_input_query_dir=f"{dataset}/128k",
